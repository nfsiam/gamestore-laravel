                    ...
                    <h4 class="font-weight-light mt-4 ml-2">Your Profile</h4>
                        <div class="my-profile-wrap d-flex flex-wrap">
                            ...
                            <div class="profile-nav-menu mt-4">
                              <nav class="navbar navbar-expand-lg navbar-light" style="background-color: #e3f2fd; border: 1px solid transparent; border-radius: 10px;">
                                <ul class="navbar-nav mr-auto">
                                  ...
                                  <li class="nav-item">
                                    <a class="nav-link" href="transactions.html"> <i class="fa fa-book"></i> Transactions </a>
                                  </li>
                            ...
                            <div class="wallet-info mt-5">
                                <h1 class="font-weight-light p-3">Your current balance is $500</h1>
                                <input type="number" class="form-control" value="0">
                                <button class="btn btn-info btn-sm mt-4">Send Recharge Request</button>
                            </div>
