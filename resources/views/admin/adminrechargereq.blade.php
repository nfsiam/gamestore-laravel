...
<body>
  <nav class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <ul class="navbar-nav px-3">
      <li class="nav-item text-nowrap">
        <a href="/enduser/logout">Logout</a>
      </li>
    </ul>
  </nav>
  ...
  <div class="container-fluid">
    ...
    @include('admin/admindashboard')
     ...
     <input  class="form-control"  type="number" placeholder="type the amount" name="bonus">
        <input class="btn btn-success" type="submit" name="submit" value="Give Bonus Now">

      </form>

      <form action="/admin/userwaletexcel" method="post">
        ...
        $.ajax({
            ...
            success: function(response){
               ...
               var html1= " <table class='table' border='1'>"+
                " <tr>"+
                " <th>id</th> <th>requester</th> <th>amount</th> <th>status</th> <th>actionby</th> <th>actionat</th>   </tr> <tbody>";
