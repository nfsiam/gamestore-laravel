        ...
        <div>
          <h2>All users</h2>
                ...
                @foreach($result as $res)
                    <tr>
                <th scope="row"></th>
                        <td class="text-primary">{{$res['id']}}</td>
                        <td class="text-primary">{{$res['username']}}</td>
                        <td class="text-primary">{{$res['email']}}</td>
                      <!-- <td><a class="btn btn-primary" href="/admin/viewprofile/{{$ -->
                      </tr>
                @endforeach
