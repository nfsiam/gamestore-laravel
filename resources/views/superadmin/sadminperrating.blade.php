            ...
            <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Rating Change Permission</th>
                ...
                <form method="POST" action="/sadmin/permissionrating" >
                <!-- @csrf -->
               <input type="hidden" name="username" value="{{$admin->username}}" >
                  <tr>
                    ...
                    <td>
                    <!-- <input type="text" name="permissionstatus" value="{{$admin->permissionstatus}}" > -->
